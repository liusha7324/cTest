#line 1 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/Card_Data.c"
...
#line 8 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/Card_Data.c"
...
#line 9 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/Card_Data.c"
...
#line 10 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/Card_Data.c"
...
#line 11 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/Card_Data.c"
...
#line 12 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/Card_Data.c"
...
#line 13 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/Card_Data.c"
...
#line 14 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/Card_Data.c"
...
#line 15 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/Card_Data.c"
...
#line 16 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/Card_Data.c"
...
#line 17 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/Card_Data.c"

#line 1 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/Card_Data.h"
#line 18 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/Card_Data.c"
...
#line 19 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/Card_Data.c"
...
void Deal_Triff_Data(unsigned char * Source_Point,unsigned char Mode)
	...
	if (!Mode)	 
		...
		Pay_EE_W(0x7fe0   - sizeof(struct JUSTMETER_PARAMETER) - sizeof(struct METER_PARAMETER)-sizeof( struct _Pay_Eeprom_Define )  +sizeof( struct _Pre_Payment_Data )+4+4+4+4+4+4 +k*(4*32            ),(unsigned char *)&(Pre_Payment_Para.Triff[k][0]),(32            )*4,3,		
		...
		Pay_EE_W(0x7fe0   - sizeof(struct JUSTMETER_PARAMETER) - sizeof(struct METER_PARAMETER)-sizeof( struct _Pay_Eeprom_Define )  +sizeof( struct _Pre_Payment_Data )+4+4+4+4+4+4+(32           )*4+(32           )*4+4+4+4+6+6+6+1+1    +sizeof(struct DATEANDTIME_DEF)+sizeof(struct DATEANDTIME_DEF)+1 +1+4+2 +k*4*(6			  ),(unsigned char *)&(Pre_Payment_Para.Energy_Step[k][0]),6			  *4,3,
				(unsigned char *)&(Pre_Payment_Para),sizeof( struct _Pre_Payment_Para ) ,0x7fe0   - sizeof(struct JUSTMETER_PARAMETER) - sizeof(struct METER_PARAMETER)-sizeof( struct _Pay_Eeprom_Define )  +sizeof( struct _Pre_Payment_Data ) );		 
		Pay_EE_W(0x7fe0   - sizeof(struct JUSTMETER_PARAMETER) - sizeof(struct METER_PARAMETER)-sizeof( struct _Pay_Eeprom_Define )  +sizeof( struct _Pre_Payment_Data )+4+4+4+4+4+4+(32           )*4+(32           )*4+4+4+4+6+6+6+1+1    +sizeof(struct DATEANDTIME_DEF)+sizeof(struct DATEANDTIME_DEF)+1 +1+4+2+(6			 *4)+(6			 *4) +k*4*(6			  +1),(unsigned char *)&(Pre_Payment_Para.Triff_Step[k][0]),(6			  +1)*4,3,
						(unsigned char *)&(Pre_Payment_Para),sizeof( struct _Pre_Payment_Para ) ,0x7fe0   - sizeof(struct JUSTMETER_PARAMETER) - sizeof(struct METER_PARAMETER)-sizeof( struct _Pay_Eeprom_Define )  +sizeof( struct _Pre_Payment_Data ) );		 
		Pay_EE_W(0x7fe0   - sizeof(struct JUSTMETER_PARAMETER) - sizeof(struct METER_PARAMETER)-sizeof( struct _Pay_Eeprom_Define )  +sizeof( struct _Pre_Payment_Data )+4+4+4+4+4+4+(32           )*4+(32           )*4+4+4+4+6+6+6+1+1    +sizeof(struct DATEANDTIME_DEF)+sizeof(struct DATEANDTIME_DEF)+1 +1+4+2+(6			 *4)+(6			 *4)+((6			 +1)*4)+((6			 +1)*4)		  +k*(12),(unsigned char *)&(Pre_Payment_Para.Year_BillDate[k][0]),3*4,3,
						(unsigned char *)&(Pre_Payment_Para),sizeof( struct _Pre_Payment_Para ) ,0x7fe0   - sizeof(struct JUSTMETER_PARAMETER) - sizeof(struct METER_PARAMETER)-sizeof( struct _Pay_Eeprom_Define )  +sizeof( struct _Pre_Payment_Data ) );		 
		if (k)	 
		{
			My_Memcpy(&Pre_Payment_Para.StepSwitchDate.Year,(unsigned char *)&(triff_data->Grad_Switch_Date[0]),5);		
			Pay_EE_W(0x7fe0   - sizeof(struct JUSTMETER_PARAMETER) - sizeof(struct METER_PARAMETER)-sizeof( struct _Pay_Eeprom_Define )  +sizeof( struct _Pre_Payment_Data )+4+4+4+4+4+4+(32           )*4+(32           )*4+4+4+4+6+6+6+1+1    +sizeof(struct DATEANDTIME_DEF) ,(unsigned char *)&(Pre_Payment_Para.StepSwitchDate.Year),5,3,
						(unsigned char *)&(Pre_Payment_Para),sizeof( struct _Pre_Payment_Para ) ,0x7fe0   - sizeof(struct JUSTMETER_PARAMETER) - sizeof(struct METER_PARAMETER)-sizeof( struct _Pay_Eeprom_Define )  +sizeof( struct _Pre_Payment_Data ) );		 
		}
		else
		{
...
void Deal_Para_Table2(unsigned char * Source_Point,unsigned char Mode)
	...
	if( Para_Updata_Flag&0x80 )
		...
		Pay_EE_W(0x7fe0   - sizeof(struct JUSTMETER_PARAMETER) - sizeof(struct METER_PARAMETER)-sizeof( struct _Pay_Eeprom_Define )  +sizeof( struct _Pre_Payment_Data )+4+4+4+4+4+4+(32           )*4+(32           )*4+4+4+4+6+6+6+1 ,&Pre_Payment_Para.User_Kind,1,3,
				(unsigned char *)&(Pre_Payment_Para),sizeof( struct _Pre_Payment_Para ) ,0x7fe0   - sizeof(struct JUSTMETER_PARAMETER) - sizeof(struct METER_PARAMETER)-sizeof( struct _Pay_Eeprom_Define )  +sizeof( struct _Pre_Payment_Data ) );
		}
	}
...
void Deal_Para_Table3(unsigned char * Source_Point,unsigned char Mode)
	...
	if( Para_Updata_Flag&0x80 )
		...
		Pay_EE_W(0x7fe0   - sizeof(struct JUSTMETER_PARAMETER) - sizeof(struct METER_PARAMETER)-sizeof( struct _Pay_Eeprom_Define )  +sizeof( struct _Pre_Payment_Data )+4+4 ,(unsigned char *)&Pre_Payment_Para.Remain_Money_Alarm1_Limit,8,3,
				(unsigned char *)&(Pre_Payment_Para),sizeof( struct _Pre_Payment_Para ) ,0x7fe0   - sizeof(struct JUSTMETER_PARAMETER) - sizeof(struct METER_PARAMETER)-sizeof( struct _Pay_Eeprom_Define )  +sizeof( struct _Pre_Payment_Data ) );	
		...
		*(((unsigned char *)&Pre_Payment_Para.P_T)+3) = 0;
		...
		Pay_EE_W(0x7fe0   - sizeof(struct JUSTMETER_PARAMETER) - sizeof(struct METER_PARAMETER)-sizeof( struct _Pay_Eeprom_Define )  +sizeof( struct _Pre_Payment_Data )+4+4+4+4+4+4+(32           )*4+(32           )*4+4 ,(unsigned char *)&Pre_Payment_Para.C_T,8,3,
				(unsigned char *)&(Pre_Payment_Para),sizeof( struct _Pre_Payment_Para ) ,0x7fe0   - sizeof(struct JUSTMETER_PARAMETER) - sizeof(struct METER_PARAMETER)-sizeof( struct _Pay_Eeprom_Define )  +sizeof( struct _Pre_Payment_Data ) );
		}
	}
...
void Deal_Run_Inf_Data(unsigned char * Source_Point,unsigned char Mode,unsigned long Money,unsigned long cnt)
	...
	Get_File_Data(2 ,0x02 ,4						 +1							 +1						 +4					 +5 					 +1								 +4			 +4			 +3							 +3							 +6								  ,6,&Run_Inf_Data->Client_ID[0]);
	Get_File_Data(2 ,0x02 ,4						 +1							 +1						 +4					 +5 					 +1								 +4			 +4			 +3							 +3							  ,6,&Run_Inf_Data->Meter_ID[0]);
	...
	if (Mode==0xB1)	 
		{
		Remain_Money_Temp=This_Month_Data.Energy_Record.Pre_Save_Data .Remain_Money+Money;
	...
	UL_Temp=0;
	Get_File_Data(2 ,0x02 ,4						 +1							 +1						 +4					 +5 					 +1								 +4			 +4			  ,3,(unsigned char *)&UL_Temp);
	...
	UL_Temp=0;
	Get_File_Data(2 ,0x02 ,4  +1  +1 +4  +5        +1 +4 +4 +3     ,3,(unsigned char *)&UL_Temp);
	My_memcpyRev((unsigned char *)&UL_Temp2,(unsigned char *)&UL_Temp,4);
	UL_Temp2>>=8;
	...
	Run_Inf_Data->Unlawful_Card_Count[1] =(unsigned char )Temp1;
 	...
 	My_Memcpy((unsigned char *)&(Run_Inf_Data->Return_DT[0]),(unsigned char *)(&MainSoftDate ),5);
	}
