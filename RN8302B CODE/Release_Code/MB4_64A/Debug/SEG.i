#line 1 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/SEG.C"
...
#line 7 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/SEG.C"
...
#line 8 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/SEG.C"
...
#line 9 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/SEG.C"
...
#line 10 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/SEG.C"
...
#line 11 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/SEG.C"
...
#line 12 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/SEG.C"
...
#line 13 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/SEG.C"
...
#line 14 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/SEG.C"
...
#line 15 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/SEG.C"
...
#line 16 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/SEG.C"
...
#line 17 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/SEG.C"
...
#line 18 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/SEG.C"
...
#line 19 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/SEG.C"
...
#line 21 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/SEG.C"
...
#line 22 "D:/TEST/12、RN8302B/2016-6-29/RN8302B CODE_2016-6-29/RN8302B CODE/Release_Code/MB4_64A/SEG.C"


unsigned long NowSegParameter;    
...
void Seg(void)
{
        ...
        unsigned char slotnumber=0,Dailyslotnumber=0;   
      ...
      if(Meter_Parameter.parameter1.TriffSwitch.SwitchDate.Month==0x99)
	    ...
	    else  Meter_Parameter.parameter1.TriffSwitch.WhitchSlotIsNow=0;    
	    ...
	    else  Meter_Parameter.parameter1.DailySlotSwitch.WhitchSlotIsNow=0;    
        ...
        {
           yeareaddr=0+10+24*9    +sizeof(struct YEARSLOT)+sizeof(struct DAILYSLOT)+sizeof(struct HOLIDAYSLOT) ;
        ...
        if(!Dailyslotnumber)     
        {
             dayeaddr=0+10+24*9    +sizeof(struct YEARSLOT) ;
        }
        else
        {
             dayeaddr=0+10+24*9    +sizeof(struct YEARSLOT)+sizeof(struct DAILYSLOT)+sizeof(struct HOLIDAYSLOT)+sizeof(struct YEARSLOT) ;
        }
		holdayeaddr=0+10+24*9    +sizeof(struct YEARSLOT)+sizeof(struct DAILYSLOT) ; 
		
        *((unsigned  char *)&NowSegParameter+0)=((slotnumber<<4)&0xf0)+(Dailyslotnumber&0x0f);
        if(!Meter_Parameter.parameter1.SlotParemeter[0].HollidayNumble) 
           table=0;
        else table=FindSlot(holdayeaddr,Meter_Parameter.parameter1.SlotParemeter[0].HollidayNumble,3);
        if(!table)
        {
           table=0x01;
           table=(table<<MainSoftDate .Week);
        ...
        *((unsigned  char *)&NowSegParameter+1)=table;    
        TRAFF_RATE=FindSlot(dayeaddr+(table-1)*14	     *3,Meter_Parameter.parameter1.SlotParemeter[0].DailySlotNumble,2);  
        if(TRAFF_RATE > (9        - 1))
           TRAFF_RATE=1; 
...
unsigned char  FindSlot(unsigned int eaddr,unsigned char maxnumber,unsigned char sort)
{
        ...
        if(sort==1 || sort==3)
        {
            *((unsigned char *)&dated+0)=MainSoftDate .Day;
            *((unsigned char *)&dated+1)=MainSoftDate .Month;
        }
        else 
        {
            *((unsigned char *)&dated+0)=MainSoftDate .Min;
            *((unsigned char *)&dated+1)=MainSoftDate .Hour;
        }
        
        if(sort!=3)
        {
           Write_Read_FM24C256 (eaddr,Co.b,maxnumber*3,0,1); 
        ...
        else    
        {
          ...
          {    
              if(i+100<maxnumber)
              	...
              	uni=maxnumber-i;
              Write_Read_FM24C256 (eeaddr,Co.b,uni*4,0,1);
              for(j=0;j<uni;j++)
              {                  
                  *((unsigned char *)&ddt[0]+0)=Co.b[j*4+1]; 
                  *((unsigned char *)&ddt[0]+1)=Co.b[j*4+2];  
                  if((dated==ddt[0])&&((Co.b[j*4+3]==0xff)||(Co.b[j*4+3]==MainSoftDate .Year)))
                  {
                      result=Co.b[j*4]; 
                      break;
                  }
