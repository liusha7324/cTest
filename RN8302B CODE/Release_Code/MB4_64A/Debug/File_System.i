#line 1 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/File_System.c"
...
#line 1 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/File_System.h"
...
#line 7 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/File_System.c"
...
#line 8 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/File_System.c"
...
#line 9 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/File_System.c"
...
#line 10 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/File_System.c"
...
#line 11 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/File_System.c"
...
#line 12 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/File_System.c"
...
#line 13 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/File_System.c"
...
{   
   ...
   show_build_char();
   Write_Read_FM24C256 (0+10+24*9    +sizeof(struct YEARSLOT)+sizeof(struct DAILYSLOT)+sizeof(struct HOLIDAYSLOT)+sizeof(struct YEARSLOT)+sizeof(struct DAILYSLOT)+sizeof(struct CYCLEDISPLAYTABLE_A)+sizeof(struct CYCLEDISPLAYTABLE_B) +5,0,3,0,0);
	if(Chip_Erase()==-1) 
	{
			p3_addr.bit.b3				       =1;
			while(1)
...
{      
    ...
    if((file_name>3488L           )||(offset==0))
        return 0;

    vd_check=int2ic_addr.byte ;
    file_name_T=file_name;
    if(file_name_T<3200L           )
    {
        if((addr+offset)>256                )
            return 0;

        FlashAddr.addr=0x200000       +(file_name_T<<8);
    ...
    else if(file_name_T<3488L           )
    {
        if(((addr+offset)>512             )) 
            return 0;

        FlashAddr.addr=0x2C8000       +((file_name_T-3200L       )<<8)*2L;
        FlashAddr.addr+=addr;    
        ...
        while((result==1)&&(badnum<1))
        {
           ...
           if(Write_Page(FlashAddr.addr,buff,256                )!=0)		    
                return 0;

           if((addr+offset)>256                )
           { 
                FlashAddr.PageAddr.Paddr+=1;
                if((FlashAddr.PageAddr.Paddr%16                 )==0) 
                    return 0;
                FlashAddr.PageAddr.Pdummy=0;
                if(Write_Page(FlashAddr.addr,buff+256                ,offset-256                )!=0)		    
                    return 0;
           }
...
unsigned int Read_File(unsigned int  file_name,unsigned int addr,unsigned int offset,unsigned char * buff)
{
    ...
    file_name_T=file_name;
    if((file_name>=3488L           )||((addr+offset)>=512             )||(offset==0))
		 return 0;
...
unsigned int  Delete_File(unsigned int file_name)
{
    ...
    else if(file_name<3488L           )
    {
        ...
        int2ic_addr.byte &=0xf8;
        if((file_name<3272L      )||
            ((file_name>=3320L   )&&(file_name<3392L     )))
        {
            file_num=72           ;
        }
		else if (file_name==3408L	 		  )
		{
			file_num=24		  ;
		}
        else 
        ...
        FlashAddr.addr=0x2C8000       ;
        FlashAddr.SectorAddr.Sdummy=0;
        FlashAddr.SectorAddr.Saddr+=(file_name_T-3200L       )/8;
