#line 1 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Cpucard_Driver.c"
...
#line 4 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Cpucard_Driver.c"
...
#line 5 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Cpucard_Driver.c"
...
#line 7 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Cpucard_Driver.c"
...
#line 9 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Cpucard_Driver.c"
...
#line 11 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Cpucard_Driver.c"

#line 1 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Card_Data.h"
#line 12 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Cpucard_Driver.c"

#line 1 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Card_File.h"
...
#line 13 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Cpucard_Driver.c"
...
#line 15 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Cpucard_Driver.c"

#line 1 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Cpucard_Driver.h"
...
void CPU_VCC_Control(unsigned char );           
                                                
void CPU_CLK_Control(unsigned char );           
                                                
void CPU_RST_Control(unsigned char );           
                                                

void ESAM_VCC_Control(unsigned char );          
                                                
void ESAM_CLK_Control(unsigned char );          
                                                
void ESAM_RST_Control(unsigned char );          
                                                

void CPU_ESAM_CARD_Control(unsigned char);      
...
unsigned char Wait_Receive(unsigned char );     
...
void My_Memcpy(unsigned char *,unsigned char *,unsigned char);  
unsigned char My_Memcmp(unsigned char *,unsigned char *,unsigned char);  
...
unsigned char cpucard_number[8];         
unsigned char ESAM_number[8];      		   

unsigned int press_card_state;            
unsigned char receive_send_buffer[512 ];  
...
#line 16 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Cpucard_Driver.c"
...
#line 17 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Cpucard_Driver.c"
...
#line 18 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Cpucard_Driver.c"

#line 1 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Far_pay.h"
...
#line 19 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Cpucard_Driver.c"
...
void Send_1Byte(unsigned char data)
    {
	    if( CommunicationPortMode==2 )
	    	{
		    while(1)
		        if(u7c1_addr.bit.b1			  ==1)
		            break;
		    u7tb_addr.byte.low			  =data;                  
	    	}
	else
		{
		    while(1)
		        if(u6c1_addr.bit.b1			  ==1)
		            break;
		    u6tb_addr.byte.low			  =data;                  
...
unsigned char Esamcard_Atr(void)
	...
	FeedWatchdog();
	return 0x00 ;  
	Pay_For_Users_Flag7.bit.ESAM_ERR =0;	 
	}
...
unsigned char Internal_Auth(unsigned char cla,unsigned char ins,unsigned char t_p1,
	...
	Order_Head[2] = t_p1;
	Order_Head[3] = t_p2;
	if( CPU_Card_Driver((const unsigned char *)Order_Head,lc,address,0,CommunicationPortMode,0)== 0x00 )
		return 0x00 ;
	if (press_card_state!=0x0014             )
...
unsigned char Select_File(unsigned char t_p1,unsigned char date1,unsigned char date2)
    {
		...
		W_Data[0] = date1;
		W_Data[1] = date2;
		if( CPU_Card_Driver((const unsigned char *)Order_Head,2,W_Data,0,CommunicationPortMode,0)== 0x00 )
			return 0x00 ;
...
unsigned char Read(unsigned char cla,unsigned char ins,unsigned char t_p1,
	...
	if( CPU_Card_Driver((const unsigned char *)Order_Head,0,0,len,CommunicationPortMode,0)== 0x00 )
		return 0x00 ;
...
unsigned char Cpucard_Esamcard_Internal_Auth(unsigned char cardType)    
{
    if(Check_CPU_Occur())			
        {
	R_CARD_ERROR_INFO=20				  ;
	...
	if ((cardType==0x01         )||(cardType==0x06         ) ||(!O1ther_Meter_Parameter.WorkRoomState))
	{
		CPU_ESAM_CARD_Control(2 );
		if( Read(0,0xb0       ,0x99,0x01,0x08) != 0x00 )
	    {
	        return 0xFF ;
	    }
		...
		My_Memcpy(receive_send_buffer+100,receive_send_buffer,8);	 

		if (Internal_Auth(0x80,0xfa,0,1,8,cpucard_number)!=0x00 )
		    return 0xFF ;

		if (Internal_Auth(0x80,0xfa,0,0,8,receive_send_buffer+100)!=0x00 )
		    return 0xFF ;
		My_Memcpy(receive_send_buffer+110,receive_send_buffer,8);	 
		
	 
		CPU_ESAM_CARD_Control(1 );
		if( Internal_Auth(0,0x88,0,1,8,receive_send_buffer+100) != 0x00 )
			return 0xFF ;
...
unsigned char Cpucard_External_Auth(void)
    ...
    My_Memcpy(receive_send_buffer+150,receive_send_buffer,8);     
    CPU_ESAM_CARD_Control(2 );    

    if (Internal_Auth(0x80,0xfa,0,2,8,cpucard_number)!=0x00 )       
	    return 0xFF ;

    if (Internal_Auth(0x80,0xfa,0,0,8,receive_send_buffer+150)!=0x00 )
	    return 0xFF ;

    CPU_ESAM_CARD_Control(1 );     
    My_Memcpy(receive_send_buffer+100,receive_send_buffer,8);            

    if( External_Auth(2,8,receive_send_buffer+100) != 0x00 )
    {
		return 0xFF ;
    }
		...
		if( *(Order_Head+1)!= 0xc0      )
			{
		        ...
		        else
		        {
					...
					OPCard_Error_format.CMD[i]=Order_Head[i];
				OPCard_Error_format.CMD[4]=cmdLen;
				OPCard_Error_format.Response[0]=receive_send_buffer[0+Length_LE];	 
...
unsigned char Remain_Money_Moneybag_Step(unsigned char Rec_Addr,unsigned char Rec_Offset)
	...
	if( CPU_Card_Driver((const unsigned char *)Order_Head,9,temp_buffer_2,0,CommunicationPortMode,0x08)!= 0x00 )
	{				    
	   return 0xFF ;
	}
	...
	if( CPU_Card_Driver((const unsigned char *)Order_Head,0x08,temp_buffer_2,0,CommunicationPortMode,0)!= 0x00 )
	{				    
	   return 0xFF ;
	}
	return 0x00 ;
...
unsigned char Remain_Money_Moneybag_Init(void)
	{
	if( Remain_Money_Moneybag_Step(3,4) != 0x00 )
		return 0xFF ;
	
	if( Remain_Money_Moneybag_Step(1,0) !=0x00 )
		return 0xFF ;
...
unsigned char Read_Esam_Moneybag_File(unsigned char * Moneybag_Data_Point)
	...
	CPU_ESAM_CARD_Control(2 );
	if(Read(0,0xb2,0x01,0x0C,0x04)!=0x00 ) 
	{
		return 0xFF ; 
	}
	My_memcpyRev(Moneybag_Data_Point,receive_send_buffer,4);
	if(Read(0,0xb2,0x03,0x0c,0x04)!=0x00 )
    {
		return 0xFF ; 
	}
...
unsigned char Esam_Remain_Money_Dec(void)
	...
	if( This_Month_Data.Energy_Record.Pre_Save_Data .Remain_Money>0 )
		{
		if( This_Month_Data.Energy_Record.Pre_Save_Data .Remain_Money<=Moneybag_Data.Remain_Money )
			Moneybag_Data.Remain_Money -= This_Month_Data.Energy_Record.Pre_Save_Data .Remain_Money;
		else
	...
	if(Moneybag_Data.Remain_Money>0)
		...
		Order_Head[2] = 0x00;
		Order_Head[3] = 0x0C;
		if( CPU_Card_Driver((const unsigned char *)&Order_Head[0],4,(unsigned char *)&Moneybag_Data.Remain_Money,0,CommunicationPortMode,0)!= 0x00 )
			return 0xFF ;
		}
	return 0x00 ;
	}
...
void Esam_Remain_Money_Do(unsigned char Flag)
{
	...
	else
	{
		...
		if(GetTimeCount(Reamin_Money_ESAM_Dec_Time,1800000l)==0)			 
	...
	if( Esam_Do_Flag == 0xFF )
	{
		...
		{
			memcpy(Pre_Payment_Data.Esam_Identity,receive_send_buffer,5);	 
		...
		if( ( (Esam_Err_Count>=2)&& Meter_Parameter.parameter1.MeterMode[1].bit.b5 )  || (Esam_Err_Flag && Flag) )
		{
			Pay_For_Users_Flag7.bit.ESAM_ERR = 1;
			Esam_Err_Count = 4;
		}
		else
			Pay_For_Users_Flag7.bit.ESAM_ERR = 0;
...
unsigned char Remain_Money_Moneybag_Add(unsigned char File_Name,unsigned char Offset,
	...
	Order_Head[3] = Offset;
	if( CPU_Card_Driver((const unsigned char *)Order_Head,9,temp_buffer_2,0,CommunicationPortMode,0x0C)!= 0x00 )
	{
		return 0xFF ;
	}
	if( Remain_Money_Point != 0 )
		...
		CPU_ESAM_CARD_Control(2 );
		if( CPU_Card_Driver((const unsigned char *)Order_Head,0x0C,temp_buffer_2,0,CommunicationPortMode,0)!= 0x00 ) 
		{
			return 0xFF ;
		}
	}
...
unsigned char Get_File_Data(unsigned char Door,unsigned char File,unsigned char Offset,
	...
	if( Read(0,0xb0       ,0x80+File,Offset,Length) != 0x00 )
		return 0xFF ;
	if( Door==2 )
...
unsigned char Esam_File_Updata(unsigned char Cpu_File_Name,
	...
	if( CPU_Card_Driver((const unsigned char *)Order_Head,Head_Length,temp_buffer_2,0,CommunicationPortMode,Updata_Data_L+4)!= 0x00 )
	{
		return 0xFF ;
	}
	...
	if( CPU_Card_Driver((const unsigned char *)Order_Head,Updata_Data_L+4,&Co.b[0],0,CommunicationPortMode,0)!= 0x00 )
	{
		R_CARD_ERROR_INFO=10				  ;
		return 0xFF ;
	}
...
unsigned char Cpu_File_Updata(unsigned char Cpu_File_Name,
	...
	Order_Head[2] = 0x80+Esam_File_Name;
	Order_Head[3] = Esam_Start_Addr;
	if( CPU_Card_Driver((const unsigned char *)Order_Head,0x11,temp_buffer_2,0,CommunicationPortMode,Updata_Data_L+4)!= 0x00 )
	{
		return 0xFF ;
	}
