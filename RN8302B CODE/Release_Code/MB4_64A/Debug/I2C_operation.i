#line 1 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/I2C_operation.C"
...
#line 3 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/I2C_operation.C"
...
#line 4 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/I2C_operation.C"
...
#line 5 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/I2C_operation.C"
...
#line 6 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/I2C_operation.C"
...
#line 7 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/I2C_operation.C"
...
#line 8 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/I2C_operation.C"
...
#line 9 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/I2C_operation.C"
...
#line 10 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/I2C_operation.C"
...
#line 11 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/I2C_operation.C"

#line 1 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Clock_time.H"
...
#line 12 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/I2C_operation.C"
...
unsigned char Write_Read_FM24C256(unsigned int Card_Addr,		 
							 		unsigned char *DataPointer,	 
						 	 		unsigned int Data_Length,		 
						 	 		unsigned char DeviceName,		 
						 	 		unsigned char OperationType);	 
...
unsigned char Write_Read_FM24C256(unsigned int Card_Addr,		 
	...
	{		
		...
		unsigned char int2ic_tempbak = 0; 
		
		DataPointer_Value=(unsigned int)DataPointer; 
		...
		if(Data_Length==0)	 
			return 0;
		if((Data_Length+(unsigned int)Card_Addr)>0x8000)	 
			return 0;
									
		SlaveAddr_CardAddr[0]=0xA2	  ;		 
		SlaveAddr_CardAddr[1]=(unsigned char)(Card_Addr>>8);			 
		SlaveAddr_CardAddr[2]=(unsigned char)(Card_Addr&0x00FF);		 
		
		  
		 
		int2ic_tempbak = int2ic_addr.byte ;
		 ...
		 if(OperationType==0)					 
		  {		    		
			   	...
			   	if(IIC_ACK_WAIT(SlaveAddr_CardAddr[0]) == 0)
					  {
			   		...
			   		SlaveAddr_CardAddr[1]=(unsigned char)(WEe_Addr>>8);			 
		        SlaveAddr_CardAddr[2]=(unsigned char)(WEe_Addr&0x00FF);		 
		   ...
		   if(OperationType==0)						 
			 ...
			 int2ic_addr.byte = int2ic_tempbak;	    
		     return	return_value;	
...
unsigned char I2C_Poll_ACK(void)			
{
	unsigned int Poll_ACK_Times=15 ;
	unsigned char return_value=0;
...
{
	unsigned char return_value=0;
	unsigned int IIC_ACK_WAIT_Times=90 ;
...
unsigned char IIC_SendChar(unsigned char inCh)
{
	...
	while(bitp--)
		...
		p3_addr.bit.b1				 		  =0 ;
		IIC_Delay(2 );
		if(inCh&0x80) p3_addr.bit.b0				 		  =1 ;
			else p3_addr.bit.b0				 		  =0 ;
		inCh<<=1;	
		IIC_Delay(2 );
		p3_addr.bit.b1				 		  =1 ;
		IIC_Delay(2 );
...
unsigned char IIC_ReadChar(unsigned char ask)
{
	...
	pd3_addr.bit.b0				  =1 ;	
	if(ask) p3_addr.bit.b0				 		  =0 ;
		else p3_addr.bit.b0				 		  =1 ;
...
void ClockChipInit(unsigned char def)
{
  unsigned char uni = 0;
	...
	unsigned char contorl[3]={0x00 ,0x00 ,0xe0	  };			
	
	Rtc_state.bit.b0 = I2cRead(0b01100100 ,0x0d +1,sizeof(count),count);	 
	count[0]&=0x02;
	if(count[0])
		{
			Clock_powerdown_record(0);
			if(ProgramRunPhaseFlag.bit.b2     ==0)
      {
	...
	Rtc_state.bit.b0 = I2cWrite(0b01100100 ,0x0d ,sizeof(contorl),contorl);  
  	if(!def)
  		{
		...
		Rtc_state.bit.b0=I2cWrite(0b01100100 ,0x00 ,sizeof(DateWeekTime),DateWeekTime);
		}		
	Rtc_state.bit.b0=I2cRead(0b01100100 ,0x00 ,sizeof(DateWeekTime),DateWeekTime);	
...
void ClockChipRead(unsigned char *t)
{
	...
	unsigned char uni = 0;
		...
		{
		Rtc_state.bit.b0 = I2cRead(0b01100100 ,0x0d +1,sizeof(temp),temp);
		temp[0]&=0x02;
		if(temp[0])	
			{
        if((0xff != IntoPowerDownFlag)&&(ProgramRunPhaseFlag.bit.b0     ==1)&&(CheckTime((unsigned char *)&MainSoftDate )))
        {
...
{	
	...
	DateWeekTime[1] = *(t+4); 
	DateWeekTime[0] = *(t+5); 
	DateWeekTime[3] = Week_data_change(*(t+6),0); 
	Rtc_state.bit.b0 = I2cWrite(0b01100100 ,0x00 ,sizeof(DateWeekTime),DateWeekTime);
...
{
	unsigned char temp;
	unsigned char contorl[3]={0x00,0x00,0xc0};	 
	
	if(ProgramRunPhaseFlag.bit.b2     ==0) 
  {
    I2cRead(0b01100100 ,0x0d +1,1,&temp);	 
    if((temp&0x02)!=0)
    {
      rtc_lossvolt_flag=0xa5a5;
    }
	...
	I2cWrite(0b01100100 ,0x0d ,sizeof(contorl),contorl);
