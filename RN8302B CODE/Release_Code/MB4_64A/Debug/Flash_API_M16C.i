#line 1 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Flash_API_M16C.c"
...
#line 1 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Flash_API_M16C.h"
...
#line 63 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Flash_API_M16C.c"
...
#line 64 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Flash_API_M16C.c"
...
#line 65 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Flash_API_M16C.c"
...
#line 66 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Flash_API_M16C.c"
...
#line 67 "D:/TEST/12、RN8302B/HT7038 CODE_backup20160225_2016-4-22/HT7038 CODE/Release_Code/MB4_64A/Flash_API_M16C.c"
...
static unsigned int near flags_reg;	 
static unsigned char cm0_saved;			 
static unsigned char cm1_saved;			 
static unsigned char pm0_saved;			 
static unsigned char pm1_saved;			 
static unsigned char prcr_saved;         
static unsigned char fmr2_saved;         
static const unsigned long block_addresses[10] = {0xFFFFE,0xEFFFE,0xDFFFE,0xCFFFE,0xBFFFE,0xAFFFE,0x9FFFE,0x8FFFE,0xEFFE,0xFFFE }; ;               
...
unsigned char FlashEraseEW1( unsigned char block )
{
	...
	{ asm("STC FLG,_flags_reg"); asm("FCLR I");} ;	 
    ...
    if( fmr0_addr.bit.b6			  && fmr0_addr.bit.b7			  )	 
    {
        ret_value =  2;
    }
	else if( fmr0_addr.bit.b7			  )		 
	{
		ret_value =  1;
	}
    else                     
							...
							unsigned int bytes)
{
	...
	*(int far *)flash_addr = 0x50;		 
	while(bytes)
	{
		...
		*(int far *)flash_addr = 0x41;						 
		*(long far *)flash_addr = *(long far *)buffer_addr;	 
							...
							unsigned int bytes)
{
	...
	if( fmr0_addr.bit.b0			  == 0 )        
	...
	else
		{
         ...
         if ((unsigned long)flash_addr & 0x1) { 
...
static void SlowMCUClock(void)
{
	...
	prcr_saved = prcr_addr.byte ;       
	prcr_addr.byte = 3;                


	 
	pm0_saved = pm0_addr.byte ;				 
	pm0_addr.byte = pm0_saved & 0xFC;		     



	 

	fmr2_saved = fmr2_addr.byte ;     
	fmr2_addr.byte = 0;               
    ...
    cm0_saved = cm0_addr.byte ;		 
    cm1_saved = cm1_addr.byte ;		 
	pm1_saved = pm1_addr.byte ;		 
...
static void RestoreMCUClock(void)			
{
	...
	pm0_addr.byte = pm0_saved;		 


	 
    cm1_addr.byte = cm1_saved;		 
    cm0_addr.byte = cm0_saved;		 
    pm1_addr.byte = pm1_saved;		 
	prcr_addr.byte = prcr_saved;	     
